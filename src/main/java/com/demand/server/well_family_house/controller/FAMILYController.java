...
public class FAMILYController {
	...
	@RequestMapping(value = "/family/email_check", method = { RequestMethod.GET, RequestMethod.POST })
	public ArrayList<User> email_check(HttpServletRequest request) {
		IDao dao = well_family_house_sqlSession.getMapper(IDao.class);
		return dao.email_check(request.getParameter("email"));
	}

	@RequestMapping(value = "/family/login", method = { RequestMethod.GET, RequestMethod.POST })
