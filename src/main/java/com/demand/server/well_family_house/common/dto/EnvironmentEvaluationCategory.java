...
public class EnvironmentEvaluationCategory {
	private int id;
	...
	public EnvironmentEvaluationCategory(int id, int fall_diagnosis_content_category_id, String name, String avatar,
	...
	public EnvironmentEvaluationCategory() {
		super();
	}
