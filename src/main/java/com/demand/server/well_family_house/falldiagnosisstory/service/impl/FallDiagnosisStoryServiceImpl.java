...
public class FallDiagnosisStoryServiceImpl implements FallDiagnosisStoryService {
	...
	@Override
	public void insertSelfDiagnosis(int fall_diagnosis_stor_id, int user_id, int self_diagnosis_category_id)
			throws Exception {
		fallDiagnosisStoryMapper.insertSelfDiagnosis(fall_diagnosis_stor_id, user_id, self_diagnosis_category_id);
	}
